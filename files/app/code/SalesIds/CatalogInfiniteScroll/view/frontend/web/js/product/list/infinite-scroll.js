...
define([
    ...
    'mage/translate',
    'jquery/ui',
    'SalesIds_CatalogInfiniteScroll/js/product/list/continue-btn'
], function ($, alert) {
    'use strict';
    ...
    $.widget('mage.productListCatalogInfiniteScroll', {
         ...
         * @return void
         */
        _abortProcessingCacheRequests: function () {
         ...
         * @return void
         */
        _primePageCache: function (url, responseContainer) {
            var self = this;
        ...
        _primeCache: function () {
            ...
            if (this.options.nextPageUrl) {
                this._primePageCache(this.options.nextPageUrl, 'nextPageCache');
            }
        },
        ...
        _initContinueBtn: function () {
            ...
            $(this.options.continueBtnContainer).continueBtn({
                ...
                onclick: $.proxy(this._loadNextPage, this),
         ...
         * @return object
         */
        _processPageContent: function (html, currentPageUrl) {
            if (!html) {
                return;
            }
         ...
         * @return bool
         */
        _isPageMostlyVisible: function (element) {
            ...
            this.handler.windowScroll = $.proxy(function () {
                ...
                if (Math.abs(scrollPos - this.pager.lastScrollPos) > ($(window).height() * 0.1)) {
                    ...
                    $(this.options.productsContainer).each(function () {
                        if (self._isPageMostlyVisible(this)) {
        ...
        _loadNextPage: function () {
            this._abortProcessingCacheRequests();
            this._hideContinueBtn();
            
            this.pager.loadingLock = 1;
            
            if (this.pager.nextPageCache) {
                this._showNextPage(this.pager.nextPageCache);
