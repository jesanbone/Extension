...
class Feed extends \Magento\Framework\Model\AbstractModel
{
    ...
    public function checkUpdate()
    {
        ...
        $installDate = strtotime($this->_deploymentConfig->get(
    ...
    {
        $params = ['locale' => $this->_getLocaleCode()];

        $curl = $this->_curlFactory->create();
        $curl->setConfig(
            [
                'timeout'   => 2,
                'useragent' => $this->_productMetadata->getName()
        ...
        $curl->write(\Zend_Http_Client::GET, $this->getFeedUrl(), '1.0', [], $params);
